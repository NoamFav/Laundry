...
export const FACILITIES = {
  ...
  toilets: {
    ...
    floor1: { name: 'Floor 1 Toilet', floor: 1, assignedRooms: ['1C', '2C'] },
    floor2: { name: 'Floor 2 Toilet', floor: 2, assignedRooms: ['3C', '4C', '5C', '6C', '7C'] },
    floor3: { name: 'Floor 3 Toilet', floor: 3, assignedRooms: ['8C', '9C', '10C', '11C', '12C'] },
    floor4: { name: 'Floor 4 Toilet', floor: 4, assignedRooms: ['13C', '14C'] }
  },
  laundry: {
