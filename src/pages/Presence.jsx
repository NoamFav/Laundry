      ...
      <div className="max-w-2xl mx-auto space-y-6">
        ...
        >
          <div className="flex justify-between items-center mb-4">
            <div>
              <h2 className="text-xl font-semibold mb-1">{currentRoom.name}</h2>
              <p className="text-purple-100 text-sm">Quick Status Toggle</p>
            </div>
        ...
        <div className="grid grid-cols-3 gap-4">
          <div className="bg-white rounded-xl shadow p-4 text-center">
            <div className="text-3xl font-bold text-green-600">{occupiedRooms.length}</div>
            <div className="text-sm text-gray-600 mt-1">Home</div>
          </div>
          <div className="bg-white rounded-xl shadow p-4 text-center">
            <div className="text-3xl font-bold text-gray-400">{emptyRooms.length}</div>
