...
export default function Dashboard() {
  ...
  const [laundryStatus, setLaundryStatus] = useState({ washer: null, dryer: null });
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 p-4 pb-24">
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        {/* 3D House View */}
        <div className="bg-white rounded-2xl shadow-lg p-6">
          <h2 className="text-xl font-semibold text-gray-800 mb-4">House Overview</h2>
          <House3D occupancy={presence} onRoomClick={handleRoomClick} />
        </div>
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          >
            ...
            <h3 className="text-lg font-semibold text-gray-800">Washing Machine</h3>
          ...
          >
            ...
            <h3 className="text-lg font-semibold text-gray-800">Dryer</h3>
            <p className="text-sm text-gray-600 mt-1">Ground Floor</p>
          </motion.button>
        </div>
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          >
            ...
            <p className="text-sm text-green-100 mt-1">Kitchen, Shower, Toilet</p>
          </motion.button>
          ...
          >
            ...
            <p className="text-sm text-purple-100 mt-1">Track presence</p>
          </motion.button>
        </div>
      </div>
    </div>
